...
/* =======================
   LECTURES DATA (SOURCE)
   ======================= */
const lectures = [
  {
    id: 1,
    title: 'কুরআন ক্লাস - ৩ (১১ জানুয়ারি ২০২৬)',
    videoUrl: 'https://www.youtube.com/embed/Jf83GEAr2Bs',
    description: 'তাজবীদের মূল নিয়মাবলী ও মাখরাজ শিক্ষা।',
    date: '১১ জানুয়ারি ২০২৬',
    quiz: [],
  },
  {
    id: 2,
    title: 'কুরআন ক্লাস - ৪ (১২ জানুয়ারি ২০২৬)',
    videoUrl: 'https://www.youtube.com/embed/nFcmV_keW-Y',
    description: 'নূন সাকিন ও তানবীনের বিধান।',
    date: '১২ জানুয়ারি ২০২৬',
    quiz: [],
  },
  {
    id: 3,
    title: 'কুরআন ক্লাস - ৭',
    videoUrl: 'https://www.youtube.com/embed/SvCpvzApr64',
  ...
  },
  {
    id: 4,
    title: 'কুরআন ক্লাস - ৮',
    videoUrl: 'https://www.youtube.com/embed/1XBJ-4iKn1w',
  ...
  },
  {
    id: 5,
    title: 'কুরআন ক্লাস - ৯',
    videoUrl: 'https://www.youtube.com/embed/2gYxGOXCufM',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/3tGxc3ogt-4',
  ...
  },
  {
    id: 7,
    title: 'কুরআন ক্লাস - ১১ (১৯ জানুয়ারি ২০২৬)',
    videoUrl: 'https://www.youtube.com/embed/YpzEXiK3w5E',
    description: 'সূরা আল-ফাতিহার সঠিক তিলাওয়াত শিক্ষা।',
    date: '১৯ জানুয়ারি ২০২৬',
    quiz: [],
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/O8Skcq2YM7U',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/6An7rZElstg',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/embed/A41KlidKBSw',
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[350px] md:min-h-[400px] overflow-hidden">
        ...
        <div className="relative h-full container mx-auto px-4 py-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-white">
            <h1 className="text-3xl md:text-4xl font-bold mb-2">{t('lms.title')}</h1>
            <p className="text-lg text-white/90">{t('lms.instructor')}</p>
          </motion.div>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          <VideoPlayer lecture={lectures[currentLecture]} lectureNumber={currentLecture + 1} />

          <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 flex justify-between">
              <Button variant="outline" onClick={handlePrevious} disabled={currentLecture === 0}>
                {t('lms.previous')}
              </Button>
              <Button onClick={handleNext} className="btn-golden text-white">
                {t('lms.next')} <ArrowRight className="ml-2 w-4 h-4" />
              </Button>
            </div>
